...
/**
 * Questa classe rappresenta il campo da gioco. Il campo
 * da gioco è rappesentatno da una griglia di posizioni. Ogni posizione
 * può contenere un solo attore.
 *
 */
public class Field
{
     ...
     * @param location posizione nel campo
     ...
     * @param location location da cui cercare le posizioni libere.
